    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.skuId) {
            this.$http({
              url: this.$http.adornUrl(`/gulimallproduct/pmsskuinfo/info/${this.dataForm.skuId}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/gulimallproduct/pmsskuinfo/${!this.dataForm.skuId ? 'save' : 'update'}`),
              method: 'post',
