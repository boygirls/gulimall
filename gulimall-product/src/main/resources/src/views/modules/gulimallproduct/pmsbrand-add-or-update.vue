    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.brandId) {
            this.$http({
              url: this.$http.adornUrl(`/gulimallproduct/pmsbrand/info/${this.dataForm.brandId}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/gulimallproduct/pmsbrand/${!this.dataForm.brandId ? 'save' : 'update'}`),
              method: 'post',
