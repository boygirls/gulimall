    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.attrId) {
            this.$http({
              url: this.$http.adornUrl(`/gulimallproduct/pmsattr/info/${this.dataForm.attrId}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/gulimallproduct/pmsattr/${!this.dataForm.attrId ? 'save' : 'update'}`),
              method: 'post',
