    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.catId) {
            this.$http({
              url: this.$http.adornUrl(`/gulimallproduct/pmscategory/info/${this.dataForm.catId}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/gulimallproduct/pmscategory/${!this.dataForm.catId ? 'save' : 'update'}`),
              method: 'post',
