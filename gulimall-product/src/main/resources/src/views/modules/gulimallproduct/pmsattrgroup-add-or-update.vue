    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.attrGroupId) {
            this.$http({
              url: this.$http.adornUrl(`/gulimallproduct/pmsattrgroup/info/${this.dataForm.attrGroupId}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/gulimallproduct/pmsattrgroup/${!this.dataForm.attrGroupId ? 'save' : 'update'}`),
              method: 'post',
